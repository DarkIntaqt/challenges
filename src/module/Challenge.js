    ...
    try {
      ...
      if (challenge.icon === 1) {
        ...
        while (i < 25) {
          i++;
          summoner.push(
            <tr className={css.loading + " IRON"} key={i}>
              <td>{i}.</td>
              <td>
                <a href={"/loading"} onClick={goTo}>
                  <LazyLoadImage
                    height={30}
                    width={30}
                    src={"https://lolcdn.darkintaqt.com/cdn/profileicon/29"}
        ...
        if (checkThresholds(thresholds)) {
          ...
          if (summoners.length === 0) {
            ...
            for (let i = 0; i < summoners.length; i++) {
              ...
              summoner.push(
                <tr
                  key={player[0] + player[7] + i}
                  className={intToTier(player[2])}
                >
                  <td>{i + 1}.</td>
                  <td>
                    <a href={userlink} onClick={goTo}>
                      ...
                      <LazyLoadImage
                        ...
                        width={30}
                        src={
                          "https://lolcdn.darkintaqt.com/cdn/profileicon/" +
                          player[3]
                        }
                        placeholderSrc={"https://lolcdn.darkintaqt.com/s/p-cb"}
          ...
          warnings.push(
            <div className={css.disabledMessage}>
              ...
              <span className={css.details}>
                ...
                it has a static highest achievable score. <br />
                If you think this challenge should have a leaderboard, please
                create an issue on{" "}
                <a
                  href="https://github.com/DarkIntaqt/challenges/issues"
                  target="_blank"
                  rel="noreferrer"
                >
                  GitHub
      ...
      try {
        if (
          ...
          warnings.push(
            <div className={css.disabledMessage} key={"exp"}>
              {t(
      ...
      if (challenge.challenge.reversed) {
        warnings.push(
          <div
            className={css.disabledMessage + " WHITEMESSAGE"}
            key={"reverse"}
          >
            {t(
      ...
      for (let i = 1; i < thresholds.length; i++) {
        ...
        thresholdTable.unshift(
          <div key={"threshold" + i} className={css.rowParentTableRow}>
            <p className={intToTier(i)} style={lineThrough}>
        ...
        <Fragment>
          <section
            className={
              ...
              css.profile +
              " " +
              css["cid" + challenge.challenge.id]
            }
          >
            <img
              src={icon}
              alt={challenge.challenge.translation.name + " challenge logo"}
            />
            <h1>{challenge.challenge.translation.name}</h1>
            <p
              className={"SILVER " + css.challengeDescription}
              style={{ margin: "0 5px 5px 10px", cursor: "auto" }}
            >
              {challenge.challenge.translation.description}{" "}
              {challenge.timestamp ? (
                <span data-nosnippet className={css.updated}>
                  ({t("Updated")}{" "}
                  <Timestamp date={challenge.timestamp * 1000} />)
                </span>
              ) : (
              ...
              {challenge.title.length > 0 ? (
                <Fragment>
                  <br />
                  <span
                    className={css.availableTitle + " " + challenge.title[0][0]}
                  >
                    <img
                      src={
                        "https://cdn.darkintaqt.com/lol/static/challenges/title.svg"
                      }
                      alt="Title"
                    />
                    {challenge.title[0][1]}
          ...
          <section className={css.leaderboardsLeft}>
            <div className={css.rowParent + " " + css.thresholdTable}>
              ...
              <div className={isLoading + " " + css.rowParentTable}>
                <div
                  className={
                    css.rowParentTableRow + " " + css.rowParentTableRowHeading
                  }
                >
                  <p>{t("Tier")}</p>
                  <p>{t("Points")}</p>
            ...
            {challenge.text !== false ? (
              <div className={css.rowParent + " object1000 " + css.field}>
                <div className={css.seoArea}>
                  <h2>{t("Info")}</h2>
                  <span>
                    {" "}
