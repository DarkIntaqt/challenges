            ...
            <div className={filterCSS.filter}>
                <div className={filterCSS.selectors + " clearfix"}>
                    ...
                    <div className={filterCSS.category} category="category">
                        ...
                        <button onClick={this.changeExtraFilter} id="2024200" type="category">
                            <img src={config.images['2024200']} alt="2024 seasonal split 2" />
                            2024.2 Seasonal
                        </button>
                ...
                <p className={css.legal}>
                    <span data-nosnippet>
                        Click <a href="https://darkintaqt.com/blog/about-challenge-tracker#what-are-all-these-filter-options-on-a-profile-page?" target="_blank" rel="noreferrer" >here</a> to get any questions about this page answered.
                    </span>
                </p>
            </div>
