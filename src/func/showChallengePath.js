...
export default function showChallengePath(challenges, challenge) {
  ...
  let capstonetext = (
    <Fragment>
      This challenge is a capstone. That means, that this challenge is like a
      category and has multiple challenges grouped under its name.
    </Fragment>
  );
    ...
    return (
      <div className={aboutChallenge.pathArea}>
        ...
        <a
          ...
          className={aboutChallenge.category}
          onClick={goTo}
        >
          ...
          <LazyLoadImage
            ...
            src={
              ...
              category.translation.name.toLowerCase().replace(" ", "") +
              ".svg"
            }
            alt={""}
          />
