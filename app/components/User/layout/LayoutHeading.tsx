...
import css from "@cgg/components/SiteHeader/siteHeader.module.scss";
...
export function LayoutHeading({
   ...
   return (
      <SiteHeader
         props={{
            iconUrl: getProfileIcon(summonerIconId),
            iconAlt: `${fullName}'s profile icon'`,
            tier,
            level: summonerLevel,
            heading: (
               <>
                  ...
                  {verified.verified && (
                     <img
                        ...
                        src={
                           "https://cdn.darkintaqt.com/lol/static/challenges/verified.png"
                        }
                     />
                  )}
