         ...
         <div>
            <h1>
               ...
               <Link href={verified ? "/social/faq" : "/verify"} prefetch={false}>
                  <VipBadge size={"2rem"} filter={verified ? "" : "grayscale(100%)"} margin="0" />
               </Link>
            </h1>
